...
export default function MockInterview() {
  ...
  if (stage === 'setup') {
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="glass-card rounded-2xl p-6 fade-in fade-in-delay-1">
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-10 fade-in">
        <div className="glass-card rounded-2xl p-8 text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-success/20 to-emerald-500/20 flex items-center justify-center mx-auto mb-4 shadow-lg">
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="glass-card rounded-2xl p-5 mb-4 h-96 overflow-y-auto fade-in fade-in-delay-1 space-y-3">
        {chat.map((msg, i) => (
